<%@ Page Title="" Language="C#" MasterPageFile="~/MasterTPFinal.Master" AutoEventWireup="true" CodeBehind="ABMCategorias.aspx.cs" Inherits="Presentacion.ABMCategorias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row row-cols-2">
        ...
        <div class="col-6">   
            <asp:Label ID="LblExiste" runat="server" Text="No se puede Eliminar la categoria porque está usada"></asp:Label>
        </div>
        <div class="col-6">
